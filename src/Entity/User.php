 ...
 * * @UniqueEntity(
 *     fields={"email"},
 *     message="Il y a un autre compte avec cet E-mail"
 * )
 */
class User implements UserInterface
{
     ...
     * @ORM\Column(type="string", length=255)
     *
     * @Assert\Length(min="10", minMessage="Vous devez introduir au moins 10 caractères")
     */
     ...
     *
     * @Assert\Length(min="100", minMessage="Vous devez introduir au moins 100 caractères")
     */
    private $description;
